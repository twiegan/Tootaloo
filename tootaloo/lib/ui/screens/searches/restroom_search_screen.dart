        ...
        body: Column(children: [
          ...
          if (_selectedRestroom != "")
            ...
            const Padding(
                ...
                child: Text("Search for a restroom"))
        ]),
      ),
