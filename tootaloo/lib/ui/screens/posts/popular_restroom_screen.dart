      ...
      body: Scaffold(
        ...
        body: Center(
          child: ListView(
            ...
            children: _restrooms
                .map((restroom) => ListTileItem(restroom: restroom))
                .toList(),
          ),
        ),
      ),
                          ...
                          Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                      'Cleanliness: ${roundDouble(widget.restroom.cleanliness, 2)}',
                              ...
                              Row(
                                children: [
                                  Text(
                                      'Internet: ${roundDouble(widget.restroom.internet, 2)}',
                                      style: const TextStyle(fontSize: 15)),
                                ],
                              ),
                              Row(
                                children: [
                                  Text(
                                      'Vibe: ${roundDouble(widget.restroom.vibe, 2)}',
                                      style: const TextStyle(fontSize: 15)),
                                ],
                              ),
                            ],
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                          'Privacy: ${roundDouble(widget.restroom.privacy, 2)}',
                                          style: const TextStyle(fontSize: 15)),
                                    ],
                                  ),
                                ],
